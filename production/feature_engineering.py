...
from new_attr import FeatureExtraction
...
def transform_features(context, params):
    ...
    """
    logging.info("Transforming dataset to create training datasets")
    ...
    logging.info("Defining pipelines for preprocessing")
    ...
    logging.info("Saving pipeline and datasets")
